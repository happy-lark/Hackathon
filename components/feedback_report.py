...
AXIS_NARRATIVE = {
    "Warm": {
        "high": "사진과 소개글에서 따뜻하고 다정한 인상이 강하게 느껴져요. "
                "상대방이 편안하게 다가올 수 있는 분위기를 자연스럽게 만들고 있어요.",
        "low": "지금 프로필은 다소 무뚝뚝하거나 중립적인 느낌으로 전달되고 있어요. "
               "따뜻함이 부족하면 첫인상에서 거리감이 느껴질 수 있어요.",
    },
    "Confident": {
...
MODE_TIPS = {
    "Job Interview": {
        "Warm": "면접에서는 과한 친근함보다 '편안하지만 예의 있는' 톤을 유지하는 게 좋아요. "
                "자연스러운 미소 정도로 조절해보세요.",
    ...
    "Networking": {
        "Warm": "네트워킹 자리에서는 따뜻함이 첫 대화를 여는 데 큰 역할을 해요. "
                "밝은 표정의 사진을 우선적으로 사용해보세요.",
    ...
    "First Date": {
        "Warm": "자연스러운 미소가 담긴 사진 한 장이 따뜻함을 가장 효과적으로 전달해요.",
